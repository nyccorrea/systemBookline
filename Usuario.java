...
public class Usuario{
    ...
    public static void main(String[] args) {
        ...
        //         validarAcesso(email_inserido, senha_inserida);
        //         System.out.println("--------------------------------------");

        //         if(validarAcesso(email_inserido, senha_inserida) == 0){
        //             //chamar métodos para discente
        //         }else if(validarAcesso(email_inserido, senha_inserida) == 1){
        //             //chamar métodos para funcionario
        //         }
        //         break;
